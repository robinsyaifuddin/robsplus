...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-[90vh] px-4 md:px-6 flex items-center cyber-grid-bg overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        ...
        >
            ...
            >
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <div 
                    key={i} 
                    className="w-8 h-8 rounded-full border-2 border-background bg-gradient-to-br from-cyber-purple to-cyber-blue flex items-center justify-center text-xs font-bold"
                  >
                    {i}
                  </div>
                ))}
              ...
              <div>
                ...
                <div className="flex text-yellow-500 mt-0.5 text-xs">
                  {[...Array(5)].map((_, i) => (
                    <span key={i}>★</span>
                  ))}
                </div>
          ...
          <motion.div 
            ...
            variants={itemVariants}
          >
            <div className="relative z-10 glassmorphism rounded-lg p-5 md:p-6 border border-cyber-purple/20">
              <motion.h3 
                className="text-lg font-bold mb-3 text-center bg-gradient-to-r from-cyber-purple to-cyber-lightBlue bg-clip-text text-transparent"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[
                  ...
                  <motion.div
                    key={service.title}
                    className="p-3 rounded-md border border-cyber-purple/10 bg-cyber-deepBlue/50 hover:bg-cyber-deepBlue/80 transition-colors"
                  ...
                  >
                    <h4 className="font-medium mb-1 text-white text-sm">{service.title}</h4>
